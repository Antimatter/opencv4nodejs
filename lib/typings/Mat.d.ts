...
export class Mat {
  ...
  undistortPoints(cameraMatrix: Mat, distCoeffs: number[], R?: Mat, P?: Mat, criteria?: TermCriteria): Mat;
  undistortPointsAsync(cameraMatrix: Mat, distCoeffs: number[], R?: Mat, P?: Mat, criteria?: TermCriteria): Promise<Mat>;
